package com.electrocardio.terminalIO;
...
import com.electrocardio.shared.STTrace;
		...
		public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
			...
			if (status != BluetoothGatt.GATT_SUCCESS) {
				...
				if (status == BluetoothGatt.GATT_INSUFFICIENT_AUTHENTICATION) {
					...
					// we would prefer to check BluetoothDevice.getBondState but calling this function leads to Bluetooth instability at least on Nexus 5... 
