package com.electrocardio.reside;
...
public class ResideMenu extends FrameLayout {
    ...
    private List<String> disabledSwipeDirection = new ArrayList<>();
    ...
    public boolean setSwipeDirectionEnable(int direction) {
        if (isInDisableDirection(direction))
            return disabledSwipeDirection.remove(direction + "");
        return true;
    }
