...
import static com.electrocardio.Adapter.BaseAdapterHelper.get;
...
public abstract class QuickAdapter<T> extends
    ...
    protected BaseAdapterHelper getAdapterHelper(int position, View convertView, ViewGroup parent) {
        if (mMultiItemSupport != null) {
            return get(context, convertView, parent, mMultiItemSupport.
                    getLayoutId(position, data.get(position)), position);
        } else {
