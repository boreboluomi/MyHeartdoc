...
import com.electrocardio.util.InputMethodUtils;


/**
 * Created by yangzhengcopy on 2016/1/14.
 * 通用的popupWindow
 */
public abstract class BasePopupWindow implements ViewCreate {
    ...
    private void initView(Activity context,int w,int h){
      ...
      /*  mCancelView = getClickToCancelView();
        if(mDismissView!=null){
   ...
   // protected abstract View getClickToCancelView();
