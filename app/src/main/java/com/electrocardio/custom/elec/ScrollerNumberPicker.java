...
public class ScrollerNumberPicker extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(widthMeasureSpec, itemNumber * unitHeight);
    ...
    private void drawLine(Canvas canvas) {
        ...
        canvas.drawLine(0, unitHeight, getMeasuredWidth(), unitHeight, linePaint);
        canvas.drawLine(0, unitHeight * 2, getMeasuredWidth(), unitHeight * 2, linePaint);
    }
...
//                R.styleable.Numb
// erPicker_selecredTextSize, 22.0f);
...
//        attribute.recycle();
    ...
    public void isNoEmpty(boolean flag) {
        noEmpty = flag;
    }

    public void setMaskHight(float height) {
        maskHight = height;
    }
    ...
    public void setSelectedFont(float size) {
        selectedFont = size;
    }

    public void setNormalFont(float size) {
        normalFont = size;
    }
    ...
    public class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            if (isSelected())
                canvas.drawText(itemText, x + getMeasuredWidth() / 2 - textRect.width()
        ...
        public boolean isInView() {
            if (y + move > controlHeight || (y + move + textRect.height()) < 0)
                return false;
            return true;
        }
        ...
        public boolean isSelected() {
            if (y + move > unitHeight / 2 && y + move < unitHeight / 2 + unitHeight) {
                return true;
            }
//            if ((y + move) >= unitHeight && (y + move) <= unitHeight + maskHight)
//                return true;
//            if ((y + move + unitHeight) >= unitHeight && (y + move + unitHeight) <= unitHeight + maskHight)
//                return true;
