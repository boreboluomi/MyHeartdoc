 ...
 */
public class SavaDataPop extends PopupWindow {

    private ImageView circle;// 图片
    private TextView content;// 内容
    private Animation animation;// 动画

    public SavaDataPop(Context context) {
        this(context, null);
    }

    public SavaDataPop(Context context, AttributeSet attrs) {
        super(context, attrs);
        View mView = LayoutInflater.from(context).inflate(R.layout.popup_savedata, null);
        // 设置view
